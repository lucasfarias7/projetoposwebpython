...
def update_pedido(id_pedido):
    try:
        ...
        # Buscar o documento utilizando o id_pedido personalizado
        ...
        if resultado_busca:
            ...
            if resultado_atualizacao.modified_count == 1:
                return f"pedido {id_cliente} e produto {id_produto} atualizado com sucesso.", 200
            else:
                return f"Erro ao atualizar pedido.", 500
        else:
            return f"pedido com id {id_cliente} não encontrado.", 404
...
def delete_pedido(id_pedido):
    try:
        ...
        if resultado_busca:
            ...
            print(resultado)
            if resultado.deleted_count == 1:
                return f"pedido {id_pedido} excluido com sucesso.", 200
            else:
